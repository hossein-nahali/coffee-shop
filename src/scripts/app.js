            ...
            const classEvents = [
                {
                    ...
                    open: [
                        {event: 'add', class: 'text-orange-300'},
                        {event: 'add', class: 'dark:text-orange-300'},
                        {event: 'remove', class: 'text-zinc-700'},
                        {event: 'remove', class: 'dark:text-white'},
                    ],
                    close: [
                        {event: 'add', class: 'dark:text-white'},
                        {event: 'remove', class: 'text-orange-300'},
                        {event: 'remove', class: 'dark:text-orange-300'},
                    ]
                },
                {
...
// card responsive
const els_open_card = document.querySelectorAll('.open-card')
const els_close_card = document.querySelectorAll('.close-card')
const card = document.querySelector('.card-responsive')
const bg_close_card = document.querySelector('.bg-close-card')
